  ...
  return (
    <Link to={`/${degreeLevel.toLowerCase()}/${slug}`}>
      <Card className="h-full overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border-none">
        ...
        <div className="p-6">
          <div className={`inline-flex items-center justify-center w-12 h-12 rounded-lg mb-4 ${degreeLevel === 'BSc' ? 'bg-primary/10' : 'bg-primary/20'} text-primary`}>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-primary text-sm font-medium">View Notes →</span>
          </div>
        </div>
      </Card>
    </Link>
